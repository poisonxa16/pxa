...
Measured on the 35B MoE at TP=2, each op captured in its own CUDA graph :
...
#
# NOT YET ENABLED. Until the re-gate with PXA_OPS_FUSED UNSET
...
def _patch_silu() -> str:
    ...
    that is exactly the kind of arm-and-never-fire failure this package already found once.
