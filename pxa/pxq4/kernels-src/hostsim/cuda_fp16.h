...
void __syncthreads();
// block-wide OR reduction barrier (k_pxq4_mmv_fused winner-flag broadcast); defined in
// pxq4_kernel_hostsim.cpp, declared here because the kernel template uses it before that point.
