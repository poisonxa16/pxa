...
// from the engine's own ggml/src/pxq-cpu.c, cutting out pxa_deq_row_pxq2 and pxa_deq_row_pxq3
// between their signature line and the closing brace at column 0 and pasting them where the
// marker below says. That is deliberate: an oracle that is
