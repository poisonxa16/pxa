           ...
           const int kslabs, const int K, const int nsplit, const int panels, const int M)
{
    ...
    // v14 GLOBAL LOOKAHEAD (2026-09-07). Every slab's weight bytes used to be loaded
    ...
    // The fix is upstream's (the sm70 AWQ_small_n_hmma_operator.md, GmemLookahead=2): keep TWO
