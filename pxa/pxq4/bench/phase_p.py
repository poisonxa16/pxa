#!/usr/bin/env python3
"""Phase P promotion gate for the fused Pascal small-op pack.
...
(2026-09-06, : see PROMOTION_CRITERIA below -- byte identity arm-vs-control at matched
...
def needle(port, model, tag, target=6500):
    ...
    max_model_len: min(target, max_model_len - 512) tokens. The old
