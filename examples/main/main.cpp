...
int main(int argc, char ** argv) {
    ...
    // PXA_AUTO_REASONING_v1: see common_chat_auto_reasoning() -- a template that ships thinking
    // off keeps it off unless the caller asked for it, and says so.
    common_chat_auto_reasoning(model, params.use_jinja, params.enable_reasoning,
