      ...
      },
      {
        ...
        label: (
          <>
            ...
            <OpenInNewTab href="https://github.com/poisonxa16/pxa/tree/main/examples/server/README.md">
        ...
        component: () => (
          <>
            <p className="mb-8">
              ...
              <OpenInNewTab href="https://github.com/poisonxa16/pxa/issues/new?template=019-bug-misc.yml">
                Bug (misc.)
              </OpenInNewTab>{' '}
