...
// the pxa engine and re-addressed for vLLM's two-tensor parameter split.
//
// PROVENANCE. Every device function below is a line-for-line copy of the corresponding
// function in /path/to/engine-repo/ggml/src/ggml-cuda/pxa/pxq6.cuh (read-only; nothing in that
