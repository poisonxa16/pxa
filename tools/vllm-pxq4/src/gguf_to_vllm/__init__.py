...
Modules, and which of them are CROSS-COMPONENT CONTRACT SURFACE:
    ...
    layout.py       CONTRACT. Panel/slab arithmetic and the blob <-> (slabs,
    ...
    reference.py    CONTRACT. The numpy bit-exactness oracle. The CUDA extension
...
The emitted contract, which components B, C and D all build against:
