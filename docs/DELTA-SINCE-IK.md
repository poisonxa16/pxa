...
Three additional upstream fixes were ported alongside the above (branch `spd/upstream-fixes`,
folded into the same release): upstream `78ce50c1` (a get_rows grid-overflow bug at large expert
