...
//   fill 3121 and +3.8% at fill 20801 on 2x V100 (spd/layer-major-prefill-20260902,
//   commit 9e7b129432). Fusing the decode into the GEMM realises that exactly instead of
//   as a cache ceiling.
//
//   The prior native attempt (K7, spd/v100-native-gemm-20260902, pxq4-mma70.cuh) proved
