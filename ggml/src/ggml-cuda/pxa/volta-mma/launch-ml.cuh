...
void launch_fattn(
    ...
    ggml_cuda_pool_alloc<half>   K_f16_buf(pool);
    ggml_cuda_pool_alloc<half>   V_f16_buf(pool);
    ...
    if (need_f16_K && K->type != GGML_TYPE_F16) {
        ...
        K_f16_buf.alloc(ggml_nelements(K));
        half * K_f16 = K_f16_buf.ptr;
    ...
    if (need_f16_V && V->type != GGML_TYPE_F16) {
        if (V_is_K_view) {
            ...
            V_f16_buf.alloc(ggml_nelements(V));
            half * V_f16 = V_f16_buf.ptr;
